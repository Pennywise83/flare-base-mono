...
export interface GovernanceVotePowerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cleanerContract"
      | "delegate"
  ...
  encodeFunctionData(
    functionFragment: "delegatedGovernanceVotePowerHistoryCleanup",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "delegatesHistoryCleanup",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface GovernanceVotePower extends BaseContract {
  connect(runner?: ContractRunner | null): GovernanceVotePower;
  waitForDeployment(): Promise<this>;

  interface: GovernanceVotePowerInterface;
  ...
  delegatedGovernanceVotePowerHistoryCleanup: TypedContractMethod<
    [_owner: AddressLike, _count: BigNumberish],
    [bigint],
    "nonpayable"
  >;

  delegatesHistoryCleanup: TypedContractMethod<
    [_owner: AddressLike, _count: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "delegatedGovernanceVotePowerHistoryCleanup"
  ): TypedContractMethod<
    [_owner: AddressLike, _count: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "delegatesHistoryCleanup"
  ): TypedContractMethod<
    [_owner: AddressLike, _count: BigNumberish],
    [bigint],
    "nonpayable"
