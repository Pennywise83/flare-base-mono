    ...
    outputs: [
      {
        type: "address",
        name: "",
        internalType: "contract IIFtsoRewardManagerV2",
      },
    ],
    name: "rewardManager",
    inputs: [],
...
export class FtsoManager__factory {
  ...
  static createInterface(): FtsoManagerInterface {
    return new Interface(_abi) as FtsoManagerInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): FtsoManager {
    return new Contract(address, _abi, runner) as unknown as FtsoManager;
  }
}
