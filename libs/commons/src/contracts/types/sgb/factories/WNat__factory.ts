...
import type { WNat, WNatInterface } from "../WNat";
...
export class WNat__factory {
  static readonly abi = _abi;
  static createInterface(): WNatInterface {
    return new Interface(_abi) as WNatInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): WNat {
    return new Contract(address, _abi, runner) as unknown as WNat;
  }
}
