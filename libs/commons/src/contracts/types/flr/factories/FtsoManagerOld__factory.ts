...
export class FtsoManagerOld__factory {
  static readonly abi = _abi;
  static createInterface(): FtsoManagerOldInterface {
    return new Interface(_abi) as FtsoManagerOldInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): FtsoManagerOld {
    return new Contract(address, _abi, runner) as unknown as FtsoManagerOld;
  }
}
