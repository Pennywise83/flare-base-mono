...
import type { FtsoOld, FtsoOldInterface } from "../FtsoOld";
...
export class FtsoOld__factory {
  static readonly abi = _abi;
  static createInterface(): FtsoOldInterface {
    return new Interface(_abi) as FtsoOldInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): FtsoOld {
    return new Contract(address, _abi, runner) as unknown as FtsoOld;
  }
}
