...
import type {
  FtsoRewardManager,
  FtsoRewardManagerInterface,
} from "../FtsoRewardManager";
...
export class FtsoRewardManager__factory {
  static readonly abi = _abi;
  static createInterface(): FtsoRewardManagerInterface {
    return new Interface(_abi) as FtsoRewardManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): FtsoRewardManager {
    return new Contract(address, _abi, runner) as unknown as FtsoRewardManager;
  }
}
