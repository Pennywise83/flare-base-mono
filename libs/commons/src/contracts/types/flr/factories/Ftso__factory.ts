...
import type { Ftso, FtsoInterface } from "../Ftso";
...
export class Ftso__factory {
  static readonly abi = _abi;
  static createInterface(): FtsoInterface {
    return new Interface(_abi) as FtsoInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Ftso {
    return new Contract(address, _abi, runner) as unknown as Ftso;
  }
}
