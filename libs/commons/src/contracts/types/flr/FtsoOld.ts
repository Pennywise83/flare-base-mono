...
export interface FtsoOldInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "priceDeviationThresholdBIPS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "priceEpochCyclicBufferSize",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace PriceFinalizedEvent {
  export type InputTuple = [
    ...
    lowRewardPrice: BigNumberish,
    highRewardPrice: BigNumberish,
  ...
  export type OutputTuple = [
    ...
    price: bigint,
    rewardedFtso: boolean,
    lowRewardPrice: bigint,
    highRewardPrice: bigint,
...
export interface FtsoOld extends BaseContract {
  connect(runner?: ContractRunner | null): FtsoOld;
  waitForDeployment(): Promise<this>;

  interface: FtsoOldInterface;
  ...
  ASSET_PRICE_USD_DECIMALS: TypedContractMethod<[], [bigint], "view">;
  ...
  assetFtsos: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  priceDeviationThresholdBIPS: TypedContractMethod<[], [bigint], "view">;

  priceEpochCyclicBufferSize: TypedContractMethod<[], [bigint], "view">;
  ...
  wNatVotePowerCached: TypedContractMethod<
    [_owner: AddressLike, _epochId: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "ASSET_PRICE_USD_DECIMALS"
  ...
  >;
  getFunction(
    nameOrSignature: "priceDeviationThresholdBIPS"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "priceEpochCyclicBufferSize"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[_votePowerBlock: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  filters: {
    ...
    "PriceFinalized(uint256,uint256,bool,uint256,uint256,uint8,uint256)": TypedContractEvent<
      PriceFinalizedEvent.InputTuple,
      PriceFinalizedEvent.OutputTuple,
      PriceFinalizedEvent.OutputObject
    >;
