...
import { DataProviderExtendedInfo, DataProviderInfo, DelegationDTO, NetworkEnum, PaginatedResult, RewardEpochSettings, VotePowerDTO, WebsocketTopicsEnum } from "../../../../../../libs/commons/src";
...
import { ProgressMap } from "../../model/progress-map";
        ...
        Utils.getParentParams(this._route).pipe(
            ...
            .subscribe(async params => {
                ...
                if (this.selectedRewardEpoch != parseInt(this._parentParams['rewardEpoch']) || this._network != this._parentParams['network']) {
                    ...
                    this._titleService.setTitle(`Flare base - ${this._network} - Delegations explorer - Reward epoch: ${this.selectedRewardEpoch}`);
